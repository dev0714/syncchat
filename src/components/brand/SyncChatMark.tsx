 ...
 * SyncChat logo. Pass a className to size it (e.g. "w-9 h-9").
 */
export default function SyncChatMark({ className, title }: { className?: string; title?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} role="img" aria-label={title ?? "SyncChat"} xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="syncchat-mark-grad" x1="0" y1="0" x2="0" y2="1">
      ...
      <path
        ...
        fill="none"
        stroke="url(#syncchat-mark-grad)"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <g fill="url(#syncchat-mark-grad)">
